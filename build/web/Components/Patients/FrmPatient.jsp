    ...
    <body>        
        ...
        <section id="content">
            <%
                ...
                String cinPatient = request.getParameter("cinPatient") != null ? request.getParameter("cinPatient") : "";
            ...
            <main>
                <div class="head-title">
                    <div class="left">
                        <h1><%= isEditMode ? "MODIFICATION" : "AJOUT" %> DE PATIENTS</h1>
                        <ul class="breadcrumb">
                            <li><a class="active color" href="${pageContext.request.contextPath}/index.jsp">Tableau de bord</a></li>
                            <li><i class='bx bx-chevron-right'></i></li>
                            <li>
                                <a class="active" href="${pageContext.request.contextPath}/Components/Patients/indexPatients.jsp">Liste des patients</a>
                            </li>
                            <li><i class='bx bx-chevron-right'></i></li>
                            <li>
                                <a class="active" href="#"><%= isEditMode ? "Modification" : "Ajout" %></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="todo">
                    <div class="container-frm-empl">
                        <div class="top-header">
                            <header><%= isEditMode ? "MODIFICATION" : "INSCRIPTION" %></header>
                            <img class="img" src="${pageContext.request.contextPath}/images/Logo.png" alt="Avatar">
                        </div>

                        <form action="${pageContext.request.contextPath}/ServletPatients" method="POST">
                            <% if (isEditMode) { %>                                                
                                <input name="cinPatient" value="<%= cinPatient %>" type="hidden">
                            ...
                            <div class="form first">
                                <div class="details personal">
                                            ...
                                            <% 
                                                ...
                                                switch(error) {
                                                    ...
                                                    case "erreur_insertion":
                                                        errorMessage = "Erreur lors de l'insertion du patient";
                                                        break;
                                                    case "erreur_systeme":
                                                        errorMessage = "Erreur système. Veuillez contacter l'administrateur.";
                                                        break;
                                                    default:
                                    ...
                                    <div class="fields">
                                        <% if (!isEditMode) { %>
                                            <div class="input-field-div">
                                                <label>CIN Patient <span class="required">*</span></label>                                                
                                                <input name="cinPatient" value="<%= cinPatient %>" type="text" placeholder="CIN Patient" required maxlength="14">
                                            </div>
                                        <% } %>
                                        ...
                                        <div class="input-field-div">
                                            ...
                                            <select name="sexe" class="form-select">
                                                ...
                                                <option value="Masculin" <%= "Masculin".equals(sexe) ? "selected" : "" %>>Homme</option>
                                                <option value="Feminin" <%= "Feminin".equals(sexe) ? "selected" : "" %>>Femme</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="fields">
                                        <div class="input-field-div">
                                            <label>Adresse</label>
                                            <input name="adresse" value="<%= adresse %>" type="text" placeholder="Adresse" maxlength="50">
                                        </div>
                ...
                <footer class="footer">
                    ...
                    <div class="footer-iconTop">
                        <a href="${pageContext.request.contextPath}/Components/Patients/indexPatients.jsp"><i class='bx bx-up-arrow-alt'></i></a>
                    </div>
                </footer>
            </main>
            <!-- --------------------- Fin Main ----------------- -->
