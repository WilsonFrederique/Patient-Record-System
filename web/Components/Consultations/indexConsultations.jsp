        ...
        <section id="content">
            ...
            <main>
                <div class="head-title">
                    ...
                    <a href="/GestionPatient/Components/Consultations/FrmConsultations.jsp" class="btn-download">
                        <i class='bx bx-plus' ></i>
                        <span class="text">NOUVELLE CONSULTATION</span>
                    </a>
                </div>

                <!-- ********************** Consultations ************************ -->

                <!--Order : Liste des consultations effectuées entre deux dates-->
                <div class="table-date">
                    <div class="orber place-recherche-entre-deux-date">
                        <div class="">
                            <div class="head">
                                <h3>Recherche de consultation par date</h3>
                            </div>

                            <!-- Formulaire de recherche par dates -->
                            <div class="date-filter-container">
                                <form method="get" action="indexConsultations.jsp" class="date-filter-form">
                                    <div class="date-input-group">
                                        <label for="date-debut">Date de consultation</label>
                            ...
                            <div class="search-results">
                                <table>
                                    ...
                                    <tbody class="tbody">
                                        <%
                                            ...
                                            if ("searchByDate".equals(actionParam) && dateDebutParam != null && dateFinParam != null 
                                                ...
                                                try {
                                                    ...
                                                    String sql = "SELECT * FROM consultations WHERE dateConsult BETWEEN ? AND ? ORDER BY dateConsult DESC";
                                        ...
                                        %>
                                        <tr>
                                            <td colspan="7" class="no-results">Aucune consultation trouvée pour la période sélectionnée</td>
                                        </tr>
                                        <%
                                                    } else {
                                                        while (rs.next()) {
                                                            ...
                                                            java.sql.Timestamp dateConsultTimestamp = rs.getTimestamp("dateConsult");
                                                            ...
                                                            String dateConsultFormatted = dateConsultTimestamp != null ? dateTimeFormat.format(dateConsultTimestamp) : "N/A";
                                                            String createdAtFormatted = createdAt != null ? dateTimeFormat.format(createdAt) : "N/A";
                                                            String updatedAtFormatted = updatedAt != null ? dateTimeFormat.format(updatedAt) : "N/A";
                                        %>
                                        <tr>
<!--                                            <td>
                                                <img src="/GestionPatient/images/C.png" alt="Avatar">
                                                <p><%= idConsult %></p>
                                            </td>-->
                                            <td>
                                                <p><%= idRdv %></p>
                                            </td>
                                            <td><span class="status process"><%= dateConsultFormatted %></span></td>
                                            <td><%= compteRendu != null ? (compteRendu.length() > 50 ? compteRendu.substring(0, 50) + "..." : compteRendu) : "N/A" %></td>
                                            <td><%= createdAtFormatted %></td>
                                            <td><%= updatedAtFormatted %></td>
                                            <td class="action-icons">
                                                <a href="/GestionPatient/Components/Consultations/FrmConsultations.jsp?edit=true&idConsult=<%= idConsult %>&idRdv=<%= idRdv %>&dateConsult=<%= dateConsultFormatted %>&compteRendu=<%= compteRendu %>" 
                                                   aria-label="Edit" title="Edit">
                                                    <i class='bx bx-edit'></i>
                                                </a>
                                                <form method="get" action="<%= request.getContextPath() %>/ServletConsultations" style="display:inline;">
                                        ...
                                        %>
                                        <tr>
                                            <td colspan="7" class="no-results">Erreur lors de la recherche: <%= e.getMessage() %></td>
                                        </tr>
                                        <%
                                                } finally {
                ...
                <!--Order : Liste complète des consultations-->
                <div class="table-date">
                    <div class="orber">
                        <div class="head">
...
<!--                                <button class="btn-modern" onclick="toggleDateSearch()">
                            ...
                            <div class="search-container">
                                <input type="search" placeholder="Rechercher une consultation..." class="search-input" style="display: none;">
                        ...
                        <table>
                            ...
                            <tbody class="tbody">
                                <%
                                    ...
                                    try {
                                        conn = DB_Connexion.getConnection();
                                        String sql = "SELECT * FROM consultations ORDER BY dateConsult DESC";
                                        stmt = conn.prepareStatement(sql);
                                        rs = stmt.executeQuery();
                                        while (rs.next()) {
                                            int idConsult = rs.getInt("idConsult");
...
<!--                                    <td>
                ...
                <footer class="footer">
                    ...
                    <div class="footer-iconTop">
                        <a href="/GestionPatient/Components/Consultations/indexConsultations.jsp"><i class='bx bx-up-arrow-alt'></i></a>
                    </div>
                </footer>
            </main>
            <!-- --------------------- Fin Main ----------------- -->
