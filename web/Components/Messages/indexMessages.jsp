                ...
                <div class="head-title">
                    <div class="left">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a class="active" href="/GestionPatient/Components/Messages/indexMessages.jsp">Liste des messages</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="orber">
                        <div class="head">
                            ...
                            <div class="search-bar">
                                <form action="/GestionPatient/Components/Messages/indexMessages.jsp" method="GET">
                                    <div class="search-container">
                                        <input type="text" name="searchTerm" placeholder="Rechercher un message..." 
                        ...
                        <% 
                            ...
                            if (success != null) {
                                String message = "";
                                switch(success) {
                                    case "confirm": message = "Rendez-vous confirmé avec succès"; break;
                                    case "cancel": message = "Rendez-vous annulé avec succès"; break;
                                }
                        %>
                            ...
                            <tbody class="tbody">
                                <%
                                    ...
                                    try {
                                        ...
                                        if (request.getParameter("searchTerm") != null && !request.getParameter("searchTerm").isEmpty()) {
                                            ...
                                            // Requête normale pour les rendez-vous en attente
                                            sql = "SELECT r.*, p.nom as nomPatient, p.prenom as prenomPatient, "
                                                + "pr.nom as nomPraticien, pr.prenom as prenomPraticien "
                                                + "FROM rendezvous r "
                                                + "LEFT JOIN patients p ON r.cinPatient = p.cinPatient "
                                ...
                                <tr>
                                    ...
                                    <td class="action-icons">
                                        <form method="POST" action="/GestionPatient/ServletRendezVous" style="display:inline;">
                                            <input type="hidden" name="action" value="confirm">
                                            <input type="hidden" name="idRdv" value="<%= idRdv %>">
                                            <button type="submit" class="btn btn-success btn-invisble" title="Confirmer">
                                        ...
                                        <form method="POST" action="/GestionPatient/ServletRendezVous" style="display:inline;">
                                            ...
                                            <input type="hidden" name="idRdv" value="<%= idRdv %>">
                                            <button type="submit" class="btn btn-danger btn-invisble" title="Annuler">
                                                <i class='bx bx-x'></i>
                                            </button>
                                        </form>
                                    </td>
