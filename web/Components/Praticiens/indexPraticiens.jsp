        ...
        <section id="content">
            ...
            <main>
                <div class="head-title">
                    <div class="left">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li><a class="active" href="/GestionPatient/Components/Praticiens/indexPraticiens.jsp">Liste des praticiens</a></li>
                            <li class="rotation"><i class='bx bx-chevron-right'></i></li>
                        </ul>
                    </div>
                    <a href="/GestionPatient/Components/Praticiens/FrmPraticiens.jsp" class="btn-download">
                        <i class='bx bx-plus'></i>
                        <span class="text">AJOUT PRATICIEN</span>
                    </a>
                </div>
                ...
                <div class="table-date">
                    ...
                    <div class="orber">
                        <div class="head">
                            <h3>Les derniers praticiens</h3>
                            <% if (request.getAttribute("resultatsRecherche") != null) { %>
                                <a href="${pageContext.request.contextPath}/Components/Praticiens/indexPraticiens.jsp" class="btn-clear-search">
                                    <i class='bx bx-x'></i>
                            ...
                            <tbody class="tbody">
                                <%
                                    ...
                                    if (resultatsRecherche != null) {
                                        for (Map<String, String> praticien : resultatsRecherche) {
                                %>
                                <tr>
                                    <td>
                                        <p><%= praticien.get("cinPraticien") %></p>
                                    </td>
                                    <td><%= praticien.get("nom") %></td>
                                    <td><%= praticien.get("prenom") %></td>
                                    <td><%= praticien.get("specialite") %></td>
                                    <td class="action-icons">
                                        <a href="/GestionPatient/Components/Praticiens/FrmPraticiens.jsp?edit=true&cinPraticien=<%= praticien.get("cinPraticien") %>&nom=<%= praticien.get("nom") %>&prenom=<%= praticien.get("prenom") %>&telephone=<%= praticien.get("telephone") %>&email=<%= praticien.get("email") %>&specialite=<%= praticien.get("specialite") %>" 
                                           aria-label="Edit" title="Edit">
                                            <i class='bx bx-edit'></i>
                                        </a>
                                        <!-- Formulaire de suppression -->
                                        <form method="get" action="<%= request.getContextPath() %>/ServletPraticiens" style="display:inline;">
                                            <input type="hidden" name="action" value="delete">
                                            <input type="hidden" name="cinPraticien" value="<%= praticien.get("cinPraticien") %>">
                                            <button type="submit" class="btn btn-danger btn-invisble" 
                                                    onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce praticien ?')">
                                ...
                                <%
                                        ...
                                        // Code existant pour afficher tous les praticiens
                                        Connection conn = null;
                                        PreparedStatement stmt = null;
                                        ResultSet rs = null;
                                        try {
                                            conn = DB_Connexion.getConnection();
                                            String sql = "SELECT * FROM praticiens";
                                ...
                                <tr>
                                    ...
                                    <td><%= specialite %></td>
                                    <td class="action-icons">
                                        <a href="/GestionPatient/Components/Praticiens/FrmPraticiens.jsp?edit=true&cinPraticien=<%= cinPraticien %>&nom=<%= nom %>&prenom=<%= prenom %>&telephone=<%= telephone %>&email=<%= email %>&specialite=<%= specialite %>" 
                                           aria-label="Edit" title="Edit">
                                            <i class='bx bx-edit'></i>
                                        </a>
                                        <!-- Formulaire de suppression -->
                                        <form method="get" action="<%= request.getContextPath() %>/ServletPraticiens" style="display:inline;">
                                            <input type="hidden" name="action" value="delete">
                                            <input type="hidden" name="cinPraticien" value="<%= cinPraticien %>">
                                            <button type="submit" class="btn btn-danger btn-invisble" 
                                                    onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce praticien ?')">
                                                    <i class='bx bx-trash'></i>
                                            </button>
                ...
                <footer class="footer">
                    ...
                    <div class="footer-iconTop">
                        <a href="/GestionPatient/Components/Praticiens/indexPraticiens.jsp"><i class='bx bx-up-arrow-alt'></i></a>
                    </div>
                </footer>
